...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Arad Tactics.py"
 
        #Name of program
        self.project_name = "Arad Tactics"
        ...
        #Author of program
        self.author_name = "Corey Kim"
        self.author_email = "yocokim@gmail.com"
        self.copyright = "Copyright (c) 2015 Corey Kim"
 
        #Description
        self.project_description = "Arad Tactics"
